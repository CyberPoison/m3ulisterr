...
- **لوحة تحكم تحليلات M3uListerr**: إحصائيات التشغيل، كرة أرضية تفاعلية، رسوم بيانية وجدول لكل جلسة
...
### البدء السريع (بدون الحاجة لـ git clone)
إذا كنت ترغب في تشغيل أحدث صورة متوفرة مباشرة، يمكنك استخدام هذا الأمر السريع:
```bash
# إنشاء مجلد للبيانات
...
### لقطات شاشة للوحة التحكم وتوضيحها

- **نظرة عامة (Overview)**: توفر لك نظرة شاملة على أداء نظامك، بما في ذلك إجمالي الجلسات والمشاهدين الفريدين وأوقات الاستجابة. كما تعرض رسوماً بيانية تفصيلية للغات الأجهزة، مزودي خدمة الإنترنت، وتوزيع الأفلام مقابل المسلسلات.
  ![Overview](wiki/Overview.png)

- **الكرة الأرضية (Globe)**: خريطة تفاعلية ثلاثية الأبعاد تتيح لك تصور التوزيع الجغرافي للمشاهدين والطلبات في الوقت الفعلي حول العالم.
  ![Globe](wiki/Globe.png)

- **الجلسات (Sessions)**: جدول مفصل يعرض كل جلسة تشغيل على حدة، ويتضمن معلومات دقيقة مثل جودة التشغيل، تقدم العرض، نوع الجهاز، مزود الخدمة (Debrid)، وعنوان الـ IP للمستخدم، مما يساعدك على تتبع نشاط المشاهدين بدقة.
  ![Sessions](wiki/Sessions.png)

- **العناوين (Titles)**: شبكة بصرية جذابة تعرض ملصقات لأكثر الأفلام والمسلسلات طلباً ومشاهدةً، مما يسهل عليك معرفة المحتوى الأكثر شعبية.
  ![Titles](wiki/Titles.png)

- **سجلات التخزين المؤقت (Cache Logs)**: أداة قوية لمراقبة عمليات التخزين المؤقت وتحليلها، مما يتيح لك تتبع نجاح وفشل استرداد الروابط والمساعدة في استكشاف أخطاء التشغيل وإصلاحها.
